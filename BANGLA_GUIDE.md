...
```
codecollab/
├── src/main/java/          ← জাভা কোড (ব্যাকএন্ড - সার্ভারের ব্রেইন 🧠)
├── src/main/resources/     ← HTML, CSS, JS (ফ্রন্টএন্ড - যা তুমি দেখো 👀)
...
## 🔐 অথেন্টিকেশন কন্ট্রোলার - লগইন/রেজিস্টার
...
## 🏠 রুম কন্ট্রোলার - রুম বানানো আর জয়েন করা

### `RoomController.java` - রুম ম্যানেজমেন্ট
...
## 💬 চ্যাট কন্ট্রোলার - রিয়েল-টাইম চ্যাট

### `ChatController.java` - মেসেজ পাঠানো আর রিসিভ করা
...
## ⌨️ কোড সিঙ্ক কন্ট্রোলার - একসাথে কোড লেখা

### `CodeSyncController.java` - কোড সবার কাছে একসাথে যায়
...
function onCodeReceived(payload) {
    ...
    if (codeMessage.sender !== username && !isTyping) {
        ...
        // কে লিখেছে দেখাও
        document.getElementById('editor-user').textContent = 
            'Last edited by: ' + codeMessage.sender;
    }
}
...
function sendCodeUpdate() {
    if (stompClient && stompClient.connected && roomId) {
        ...
        // সার্ভারে পাঠাও - সার্ভার সবাইকে ব্রডকাস্ট করবে
...
## এই ওয়েবসাইটে কী কী শিখলাম?

| ফাইল | কী করে |
|------|--------|
| `CollaborateApplication.java` | অ্যাপ চালু করে |
| `WebSocketConfig.java` | রিয়েল-টাইম কানেকশন সেটআপ |
| `User.java`, `Room.java` | ডাটার গঠন |
| `AuthController.java` | লগইন/রেজিস্টার API |
| `RoomController.java` | রুম বানানো/জয়েন করা |
| `ChatController.java` | চ্যাট মেসেজ হ্যান্ডল |
| `CodeSyncController.java` | কোড সিঙ্ক করে |
| `collab.js` | ফ্রন্টএন্ড জাদু! |
